...
Generated by Skribe - Smart Healthcare Dictation
    ...
    try {
      const response = await fetch("https://agents.toolhouse.ai/a47f921e-bf65-48ca-a612-6b88c9516cd0", {
        ...
        body: JSON.stringify({
          ...
          Trans: ${summaryData?.patient_name}`
        })
      });
  ...
  const handleSecondaryConsultation = async () => {
    setLoadingConsultation(true);
    try {
      const response = await fetch("https://agents.toolhouse.ai/c489934e-241c-4839-819e-cec28ef52da1", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        }
      ...
      if (response.ok) {
        ...
        alert("Failed to get consultation data. Please try again.");
      }
    } catch (error) {
          ...
          >
            ...
            <div className="glass-dark rounded-2xl p-8 shadow-xl">
              ...
              <div className="flex justify-center gap-4">
                ...
                <Button 
                  onClick={handleSecondaryConsultation}
                  className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold tracking-wide">
